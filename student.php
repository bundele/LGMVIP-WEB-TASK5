...
<body>
    <?php
        ...
        $result_sql=mysqli_query($conn,"SELECT `English`, `Marathi`, `Hindi`, `Maths`, `ICT`, `marks`, `percentage` FROM `result` WHERE `rno`='$rn' and `class`='$class'");
            ...
            <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td> <?php echo '<p>'.$English.' / 100</p>';?> </td>
                  </tr>
                
                  <tr>
                    <td> 2 </td>
                    <td colspan="10">Paper 2 </td>
                    <td> <?php echo '<p>'.$Marathi.' / 100</p>';?></td>
                  </tr>
            
                  <tr>
                    <td> 3 </td>
                    <td colspan="10">Paper 3 </td>
                    <td> <?php echo '<p>'.$Hindi.' / 100</p>';?> </td>
                  </tr>
            
                  <tr>
                    <td> 4 </td>
                    <td colspan="10">Paper 4 </td>
                    <td> <?php echo '<p>'.$Maths.' / 100</p>';?> </td>
                  </tr>
            
                  <tr>
                    <td> 5 </td>
                    <td colspan="10">Paper 5 </td>
                    <td> <?php echo '<p>'.$ICT.' / 100</p>';?> </td>
                  </tr>
                </tbody>
